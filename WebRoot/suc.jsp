...
<body>
	...
	<a href="originals.jsp">点击此处继续购物</a>
	<h1  align="center" style="color: blue;">尊敬的<%=(String)session.getAttribute("ip")%>顾客，感谢的购买</h1>
	<h1  align="center" style="color: blue;">你的订单编号<%=session.getAttribute("orderid") %></h1>
	<h3  align="center" style="color: blue;">请扫码添加管理员微信</h3>
	<h3  align="center" style="color: blue;"><img alt="" id="pic" height="10%" src="images/paymoney.png"></h3>
